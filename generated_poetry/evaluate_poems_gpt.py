...
parser = argparse.ArgumentParser(description='Evaluate poems using chatgpt')
...
def main():
  ...
  poems = pd.read_csv(args.input,header=None, on_bad_lines='skip')
  ...
  for i in tqdm(range(len(poems))):
    ...
    with open(args.output, 'a') as f:
        ...
        csvwriter.writerow([prompt, evaluation])
    # except:
    #     print('Sleeping...')
    #     time.sleep(40)
